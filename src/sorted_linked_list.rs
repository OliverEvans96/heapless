...
impl_index_and_const_new!(LinkedIndexU8, u8, new_u8, {u8::MAX as usize}); // val is 2^8 - 2 (one less than max)
impl_index_and_const_new!(LinkedIndexU16, u16, new_u16, {u16::MAX as usize}); // val is 2^16 - 2
impl_index_and_const_new!(LinkedIndexUsize, usize, new_usize, {usize::MAX as usize}); // val is 2^32 - 2
